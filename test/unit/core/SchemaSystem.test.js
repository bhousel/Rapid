    ...
    describe('merge', () => {
      ...
      describe('merge add', () => {
        ...
        describe('locations', () => {
          it('adds custom locations in FeatureCollection', () => {
            const resolver = context.systems.locations.resolver();
            assert.isOk(resolver.resolveLocation('surf-city-nj.geojson'));  // added to LocationConflation cache
          });
      ...
      describe('merge update', () => {
        ...
        describe('locations', () => {
          it('adds custom locations in FeatureCollection', () => {
            const resolver = context.systems.locations.resolver();
            assert.isOk(resolver.resolveLocation('surf-city-nc.geojson'));  // added to LocationConflation cache
          });
