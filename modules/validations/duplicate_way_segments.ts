...
/**
 * Factory that creates a validator for detecting duplicate way segments.
 ...
 */
export function validationDuplicateWaySegments(context: Context): ValidatorFunction {
  const type = 'duplicate_way_segments' as ValidatorID;
