 ...
 */
export function validationDisconnectedWay(context: Context): ValidatorFunction {
   ...
   */
  const validation = function checkDisconnectedWay(entity: OsmEntity, graph: Graph): ValidationIssue[] {
    if (!schema) return [];
