 ...
 */
export function validationShortRoad(context: Context): ValidatorFunction {
   ...
   */
  const validation = function checkShortRoad(entity: OsmEntity, graph: Graph): ValidationIssue[] {
