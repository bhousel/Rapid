 ...
 */
export function validationMismatchedGeometry(context: Context): ValidatorFunction {
   ...
   */
  const validation = function checkMismatchedGeometry(entity: OsmEntity, graph: Graph): ValidationIssue[] {
    if (!schema) return [];
