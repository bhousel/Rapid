...
export class UiRapidAddDataset extends EventEmitter {
  ...
  render() {
    ...
    /* Heading section */
    let $heading = $content.selectAll('.rapid-add-dataset-heading')
      .data([0]);
    ...
    /* Text section */
    let $textSection = $content.selectAll('.rapid-add-dataset-text')
      .data([0]);
    ...
    // update
    $textSection = $textSection.merge($$textSection);
